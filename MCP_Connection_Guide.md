# US Stock MCP (Unified Hub) Connection Guide
...
```powershell
C:/program_files/.venv/Scripts/python.exe C:/program_files/server/cells_apply/us_stock_mcp_v1/mcp_hub/launch_stdio.py
```
