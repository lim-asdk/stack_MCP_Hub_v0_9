...
def worker_main(inbox_payload: dict) -> dict:
    try:
        ...
        url = f"https://financialmodelingprep.com/api/v3/institutional-holder/{symbol}?apikey={financial_key}"
        ...
        if "403" in str(e):
            return {"ok": True, "data": {"symbol": symbol, "institutionalHolders": []}, "error": "403 Forbidden - financial Free Tier"}
