...
def fetch_yahoo_table(url: str):
    ...
    try:
        ...
        # Yahoo's table structure might change, so we use iloc for robustness if name-based fails
...
def worker_main(inbox_payload: dict) -> dict:
    try:
        ...
        data = {
            "gainers": fetch_yahoo_table("https://finance.yahoo.com/markets/stocks/gainers/"),
            "losers": fetch_yahoo_table("https://finance.yahoo.com/markets/stocks/losers/"),
            "most_active": fetch_yahoo_table("https://finance.yahoo.com/markets/stocks/most-active/"),
